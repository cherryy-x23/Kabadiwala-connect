...
export const createWasteSchema = z.object({
  ...
  photo: z.undefined({ invalid_type_error: 'photo metadata cannot be supplied directly by client' }),
...
export const updateWasteSchema = z.object({
  ...
  notes: z
    ...
    .optional(),
  // Disallowed fields
  photo: z.undefined({ invalid_type_error: 'photo metadata cannot be directly updated here' }),
